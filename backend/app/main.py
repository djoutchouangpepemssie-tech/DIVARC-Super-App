...
from .routers import (admin, ads, assistant, auth, discovery, market, messaging, notifications, pay,
                      push, social, store, wallet, ws)
...
for r in (auth, wallet, messaging, social, market, ads, store, admin, assistant, ws, notifications, pay, discovery, push):
