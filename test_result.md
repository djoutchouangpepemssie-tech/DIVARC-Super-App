...
backend:
  ...
  - task: "App Store enriched: real market apps catalog (36 apps) + brand logos [PHASE10]"
    ...
    status_history:
        -working: "NA"
        -agent: "main"
        -comment: "Replaced STORE_APPS with 36 REAL market apps (Instagram, TikTok, Facebook, X, Snapchat, Pinterest, Reddit, Threads, LinkedIn, YouTube, Twitch, WhatsApp, Telegram, Messenger, Signal, Discord, Netflix, Prime Video, Disney+, Spotify, Deezer, PayPal, Revolut, Coinbase, Uber, BlaBlaCar, Amazon, Vinted, Zalando, Uber Eats, Deliveroo, Notion, Slack, Zoom, Dropbox, Tinder, Bumble). Each app now has: id, name, slug, color(brand hex), cat(one of Social/Réseaux pro/Vidéo/Messagerie/Streaming/Musique/Finance/Mobilité/Shopping/Repas/Productivité/Rencontre), logo(https://cdn.simpleicons.org/<slug>/FFFFFF), emoji, desc(category-based), perms(category-based), featured(bool), rating(4.2-4.95), users(millions), reviews. GET /store/apps now sorts featured-first then users desc. Old store_apps cleared for reseed. Connect/disconnect/connections mechanic UNCHANGED (pseudonym divarc-xxxx, scopes=perms). Verify: GET /store/apps returns 36 apps with new fields; cat filter (e.g. Social) works; connect 'instagram' creates pseudonym divarc-xxxx with scopes=['Profil','Photos','Contacts']; idempotent; disconnect; multi-user isolation."
        -working: true
        -agent: "testing"
